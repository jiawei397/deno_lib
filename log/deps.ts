...
export type { HandlerOptions, LogMode } from "https://deno.land/std@0.106.0/log/handlers.ts";
export type { LevelName, LogConfig } from "https://deno.land/std@0.106.0/log/mod.ts";
